...
const CATEGORY_RULES = [
  ...
  { pattern: /airtable\.com/, category: CATEGORIES.PRODUCTIVITY, confidence: 0.9 },
  { pattern: /asana\.com/, category: CATEGORIES.PRODUCTIVITY, confidence: 0.9 },
  { pattern: /monday\.com/, category: CATEGORIES.PRODUCTIVITY, confidence: 0.9 },
  { pattern: /clickup\.com/, category: CATEGORIES.PRODUCTIVITY, confidence: 0.85 },
  { pattern: /notion\.so/, category: CATEGORIES.PRODUCTIVITY, confidence: 0.9 },
  { pattern: /confluence\.atlassian\.com/, category: CATEGORIES.PRODUCTIVITY, confidence: 0.95 },
  ...
  // Communication (NEW)
  { pattern: /web\.whatsapp\.com/, category: CATEGORIES.COMMUNICATION, confidence: 0.85 },
  { pattern: /web\.telegram\.org/, category: CATEGORIES.COMMUNICATION, confidence: 0.85 },
  { pattern: /discord\.com/, category: CATEGORIES.COMMUNICATION, confidence: 0.75 },
  { pattern: / messenger/, category: CATEGORIES.COMMUNICATION, confidence: 0.8 },

  // Gaming (NEW)
  { pattern: /store\.steampowered\.com/, category: CATEGORIES.GAMING, confidence: 0.95 },
  { pattern: /epicgames\.com/, category: CATEGORIES.GAMING, confidence: 0.9 },
  { pattern: /roblox\.com/, category: CATEGORIES.GAMING, confidence: 0.9 },
  { pattern: /itch\.io/, category: CATEGORIES.GAMING, confidence: 0.85 },
  { pattern: /miniclip\.com/, category: CATEGORIES.GAMING, confidence: 0.8 },
  { pattern: /kongregate\.com/, category: CATEGORIES.GAMING, confidence: 0.8 },

  // Shopping (NEW)
  { pattern: /amazon\.com/, category: CATEGORIES.SHOPPING, confidence: 0.9 },
  { pattern: /ebay\.com/, category: CATEGORIES.SHOPPING, confidence: 0.9 },
  { pattern: /etsy\.com/, category: CATEGORIES.SHOPPING, confidence: 0.85 },
  { pattern: /shopify\.com/, category: CATEGORIES.SHOPPING, confidence: 0.8 },
  { pattern: /walmart\.com/, category: CATEGORIES.SHOPPING, confidence: 0.9 },

  // News (NEW)
  { pattern: /cnn\.com/, category: CATEGORIES.NEWS, confidence: 0.85 },
  { pattern: /bbc\.com/, category: CATEGORIES.NEWS, confidence: 0.85 },
  { pattern: /nytimes\.com/, category: CATEGORIES.NEWS, confidence: 0.85 },
  { pattern: /theguardian\.com/, category: CATEGORIES.NEWS, confidence: 0.85 },
  { pattern: /reuters\.com/, category: CATEGORIES.NEWS, confidence: 0.9 },
  ...
  { pattern: /imdb\.com/, category: CATEGORIES.ENTERTAINMENT, confidence: 0.85 },
  { pattern: /rottentomatoes\.com/, category: CATEGORIES.ENTERTAINMENT, confidence: 0.85 },
  ...
  { pattern: /snapchat\.com/, category: CATEGORIES.TIME_WASTE, confidence: 0.8 },
  { pattern: /threads\.net/, category: CATEGORIES.TIME_WASTE, confidence: 0.75 },
];
...
export function getCategoryColor(category) {
  const colors = {
    ...
    [CATEGORIES.COMMUNICATION]: '#74B9FF',
    [CATEGORIES.GAMING]: '#A29BFE',
    [CATEGORIES.SHOPPING]: '#FDCB6E',
