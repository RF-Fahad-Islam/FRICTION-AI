...
{ "summary": "2-3 sentences overview" }`}]},contents:[{role:`user`,parts:[{text:`Links:\n${JSON.stringify(e,null,2)}`}]}],generationConfig:{maxOutputTokens:200,temperature:.5,responseMimeType:`application/json`}}}function r(e){return{systemInstruction:{role:`system`,parts:[{text:`You are a web browsing classifier. Group the following URLs into specific, highly descriptive categories based on their content.
